...
public class Lib {
	...
	public static final String[] CODE_SECTIONS = new String[] {".plt.got", ".plt", ".text"};
	public static final String[] DATA_SECTIONS = new String[] {".rodata", ".idata", ".data", ".bss", ".got", ".eh_frame", ".eh_frame_hdr"};
	public static final String[] RODATA_SECTIONS = new String[] {".plt.got", ".plt", ".text", ".rodata", ".idata", ".got", ".eh_frame", ".eh_frame_hdr"};
	public static final HashSet<String> RWDATA_SECTIONS = new HashSet<>(Arrays.asList(".data", ".bss"));
	
	public static final String[] SECTIONS = new String[] {".plt.got", ".plt", ".text", ".rodata", ".idata", ".data", ".bss", ".got", "extern", ".eh_frame", ".eh_frame_hdr"};
