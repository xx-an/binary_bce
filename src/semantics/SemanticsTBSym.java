...
//	        Long new_address = SMTHelper.get_jump_address(store, rip, jump_address_str);
	        if(new_address != null && (address_ext_func_map.containsKey(new_address) || dll_func_info.containsKey(new_addr))) {
